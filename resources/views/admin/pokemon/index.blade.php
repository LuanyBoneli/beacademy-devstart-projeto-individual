...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('admin.pokemon.store')}}" enctype="multpart/form-data">
                @csrf
                <div class="row">
                    <div class="col">
                        <div class="mb-3 row">
                    ...
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="price" value="{{old('height')}}" type="number" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="name" value="{{old('weight')}}" type="number" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="price" value="{{old('category')}}" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="price" value="{{old('abilities')}}" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="name" value="{{old('hp')}}" type="number" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="price" value="{{old('attack')}}" type="number" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="price" value="{{old('defense')}}" type="number" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="name" value="{{old('special_attack')}}" type="number" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="price" value="{{old('special_defense')}}" type="number" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="price" value="{{old('speed')}}" type="number" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9 col-md-6 col-sm-12">
                                <input name="price" value="{{old('gender')}}" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3 row">
                            <label class="col-lg-3 col-md-6 col-sm-12 col-form-label">Imagem:</label>
                            <div class="col-lg-9 col-md-6 col-sm-12">
